...
<body class="" style="	box-shadow: 0px 0px 4px  black;	text-shadow: 0px 0px 4px w;">
  ...
  <!-- Modal Tambah -->
  <div class="modal fade" id="modalSurat" tabindex="-1" style="display: none; background-image: url(&quot;C:/Users/USER/Downloads/IMG_20250618_113212.jpg&quot;); background-position: left top; background-size: 100%; background-repeat: repeat;" aria-hidden="true">
    <div class="modal-dialog">
      <form class="modal-content" id="formSurat">
        <div class="modal-header">
          <h5 class="modal-title">Tambah Surat</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
        </div>
        <div class="modal-body">
          <input type="text" class="form-control mb-2" name="nomor" placeholder="Nomor Surat" required="">
          <select class="form-select mb-2" name="jenis" required="">
            <option value="">-- Pilih Jenis --</option>
            <option value="Masuk">Masuk</option>
            <option value="Keluar">Keluar</option>
            <option value="keluar">Surat Tugas</option>
            <option value="keluar">KGB</option>
            <option value="keluar">Permohonan Cuti</option>
            <option value="Keluar">Rekap Kehadiran</option>
            <option value="Keluar">Blangko</option>
            <option value="Masuk">SKP</option>
            <option value="Masuk">USUL PANGKAT</option>
            <option value="Masuk">Administrasi Pegawai</option>
            <option value="Masuk">SPPD</option>
          </select>
          <input type="date" class="form-control mb-2" name="tanggal" required="">
          <textarea class="form-control mb-2" name="perihal" placeholder="Perihal Surat" required=""></textarea>
        </div>
        <label for="file">Pilih file yang ingin diupload:</label><br><br>
        <input type="file" name="file" id="file" required=""><br><br>
      </form>
      <div class="modal-footer">
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalSurat">+ SIMPAN</button>
      </div>
